###############################################################################
# EM-CAMS v.3.0.0 - Phase 8: Time Dimension Conversion
###############################################################################
...
cat("Starting Phase 8: Time Dimension Conversion\n")

# Load computation module
source("scripts/computation/Computation/TimeConversion.R")

# Configuration
input_folder <- "data/processed/DAILY_data/EM_sum"
output_folder <- "data/processed/DAILY_data/EM_sum_CF"  # New folder for CF-compliant files
backup_enabled <- TRUE
overwrite_original <- FALSE  # Set to TRUE to overwrite original files
